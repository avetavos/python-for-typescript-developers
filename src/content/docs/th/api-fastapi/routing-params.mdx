...
<TsGo ts={basicRouteTs} go={basicRoutePy} />
...
export const pathPy = `# FastAPI — type hint แปลง + validation
from fastapi import FastAPI
...
async def search_items(
    ...
    q: str | None = None,  # GET /items?q=widget
):
    return {"skip": skip, "limit": limit, "q": q}`;

<TsGo ts={queryTs} go={queryPy} />
