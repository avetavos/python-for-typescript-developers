...
export const conftestTreeDiagram = `flowchart TD
  tests["tests/"]
...
<Mermaid code={conftestTreeDiagram} title="conftest.py fixture scoping by directory" />
