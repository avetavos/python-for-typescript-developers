...
`uv` (by Astral, the ruff team) is a Rust-powered replacement for pip and venv combined. It is 10–100× faster than pip, handles virtual environments automatically, and installs interpreters too — so it is the default recommendation for new projects. Read layers 1 and 2 to understand what it is doing for you; reach for layer 3 in practice.
