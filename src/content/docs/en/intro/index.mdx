...
Python 3.14's REPL is a genuinely nice shell: syntax highlighting and colour are on by default, multiline editing works, and errors suggest the keyword you meant. Set `PYTHON_BASIC_REPL=1` if you need the old plain one.
